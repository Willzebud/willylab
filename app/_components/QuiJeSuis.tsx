        ...
        <div className="z-10 w-full">
          ...
          <div className="bg-brand-dark flex flex-col lg:flex-row items-center justify-center lg:gap-10 gap-4 w-full">
            ...
            <div className="flex-shrink-0 md:mb-0 mx-auto md:mx-0 pl-6">
              <div
                className="relative w-40 h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 overflow-hidden shadow-lg"
                style={{
              ...
              >
                <Image
                  ...
                  alt="Logo alternatif de Nopheïa"
                  fill
                  priority // ⚡ Optimiser le chargement du logo
            ...
            <div className="flex flex-col">
              <p className="text-base sm:text-xl text-justify text-brand-cream mt-4 px-4 py-4 lg:pr-8 sm:pb-4 lg:pb-8 font-playfair">
                ...
                diplômée d&apos;État et ambassadrice de la méthode GAD® depuis 3
                ans. <br />
                <br />
                Elle s&apos;adresse à toutes les femmes qui souhaitent estomper
                ...
                grâce à une méthode 100% naturelle et bienveillante.
              </p>

              <Link href="/nopheia" className="w-full flex justify-center mt-5">
