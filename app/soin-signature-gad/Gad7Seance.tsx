    ...
    <Section className="pt-[100px]">
      <div className="relative z-0 w-full mx-auto overflow-hidden xl:w-[80%] max-w-[95%] min-h-[400px] flex flex-col lg:flex-row items-center justify-between lg:gap-8">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div>
            <div className="mt-12 w-full flex flex-col lg:flex-row items-center justify-center gap-8">
              {/* Bloc bouton + texte sous bouton */}
              <div className="flex flex-col items-center">
                {/* Grouper bouton + prix ensemble */}
          ...
          {/* Texte sous le bouton uniquement */}
          <p className="text-brand-dark text-sm mt-4 text-center">
